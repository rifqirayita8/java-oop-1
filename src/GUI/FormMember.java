...
public class FormMember extends javax.swing.JFrame {
    ...
    public FormMember() {
        initComponents();
        dataMember = new ArrayList<Member>();
        dataMember.add(new Member("Bu Yuli",45));
        dataMember.add(new Member("Bu Yuni",40));
        dataMember.add(new Member("Indah",20));
        
        String[] kolom = {"Nama","Usia"};
        ...
        for (int i=0;i<dataMember.size();i++){
            model.addRow(new Object[]{
                dataMember.get(i).getNama(),
                dataMember.get(i).getUsia()
            });
